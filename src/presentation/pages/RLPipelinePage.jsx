...
const RLPipelinePage = ({
    ...
    return (
        <div className={`min-h-screen bg-coffee-950 text-coffee-100 p-4 md:p-6 flex flex-col animate-in fade-in duration-500 overflow-y-auto ${theme}`}>
            ...
            <div className="flex-1 flex flex-col rounded-[32px] border border-coffee-700 bg-coffee-900/90 shadow-2xl overflow-hidden">
                <div className="px-5 pt-5 pb-3 border-b border-coffee-700/70 bg-coffee-950/35">
                ...
                <div className="flex-1 p-3 md:p-5">
                    <RLPipelineFlow
                        ...
                        desktopHeightClass="h-[calc(100vh-280px)]"
                    />
                </div>
            </div>
