...
const PrePhase2Transition = ({
    ...
    return (
        <div className={`h-screen w-full bg-coffee-900 text-coffee-100 flex flex-col items-center p-2 md:p-8 relative overflow-x-hidden overflow-y-auto transition-colors duration-500 ${theme}`}>
            ...
            <motion.div
                ...
                className="z-10 my-auto w-full min-w-0 max-w-[95vw] lg:max-w-5xl p-2 md:p-8"
            >
