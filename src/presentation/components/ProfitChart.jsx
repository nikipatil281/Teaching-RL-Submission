...
const CUPS_SOLD_AXIS_COLOR = 'var(--chart-cups-axis)';
const CUPS_SOLD_BAR_COLOR = 'var(--chart-cups-bar)';
const HISTORY_ACTION_COLOR = 'var(--history-action-color)';
const HISTORY_ACTION_LINE_COLOR = 'var(--history-action-line-color)';
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            ...
                            >
                                ...
                                <YAxis
                                    yAxisId="right"
                                    orientation="right"
                                    stroke={CUPS_SOLD_AXIS_COLOR}
                                    tick={{ fill: CUPS_SOLD_AXIS_COLOR, fontSize: 10 }}
                                    label={{ value: 'Cups Sold', angle: 90, position: 'insideRight', offset: 0, fill: CUPS_SOLD_AXIS_COLOR, fontSize: 10 }}
                                />
                            ...
                            <div className="px-4 pt-4 pb-4 border-b border-coffee-700/40 bg-coffee-800/80">
                                ...
                                <div className="mt-2 grid grid-cols-12 gap-1.5 text-center">
                                    ...
                                    <div className="col-span-1">
                                        <div className="text-xs font-semibold" style={{ color: HISTORY_ACTION_COLOR }}>Action</div>
                                        <div className="relative mt-2 px-1 pt-3">
                                            <div className="absolute left-0 right-0 top-0 border-t" style={{ borderColor: HISTORY_ACTION_LINE_COLOR }} />
                                            <div className="absolute left-0 top-0 h-3 border-l" style={{ borderColor: HISTORY_ACTION_LINE_COLOR }} />
                                            <div className="absolute right-0 top-0 h-3 border-r" style={{ borderColor: HISTORY_ACTION_LINE_COLOR }} />
                                        </div>
                                    </div>
