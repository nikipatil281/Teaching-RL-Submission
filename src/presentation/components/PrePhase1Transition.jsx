...
import { WEEKLY_START_INVENTORY, WASTAGE_COST_PER_CUP } from '../../domain/constants/marketConstants';
...
const PrePhase1Transition = ({ onComplete, onBackToStory, theme }) => {
    ...
    return (
        <div className={`h-screen w-full bg-coffee-900 text-coffee-100 flex flex-col items-center p-4 md:p-8 relative overflow-x-hidden overflow-y-auto transition-colors duration-500 ${theme}`}>
            ...
            <motion.div
                ...
                className="z-10 my-auto w-full min-w-0 max-w-[90rem] p-4 md:p-8"
            >
